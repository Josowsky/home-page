...
const AboutPage = ({ data }) => (
  <StyledContainer>
    ...
    <Paragraph>
      Hi, I&apos;m Bartek. I am a Web Developer and web technologies passionate.
      Currently, I work remotely as a Frontend Developer at{' '}
      <a
        target="_blank"
    ...
    <Paragraph>
      ...
      years. I’m most proficient with frontend but I also did some backend work
      in Node.js and I have experience with AWS, Nginx, and Docker. At the
      moment my stack consists of React with TypeScript, react hooks,
    ...
    <Paragraph>
      ...
      and traveling. If you&apos;re a developer and you&apos;re gathering a team
